<x-app-layout>
    ...
    <div class="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-5">
            <p class="text-sm text-gray-500">Manage your suppliers and their CLT layup data.</p>
                ...
                <tbody class="divide-y divide-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('suppliers.export', $supplier) }}"
                                   class="text-green-600 hover:text-green-800 text-xs font-medium">Export</a>
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center">
                            <div class="text-gray-400 text-sm">No suppliers yet.</div>
                            <a href="{{ route('suppliers.create') }}"
